...
describe('WizardPage (FR-WZD-02..06)', () => {
  it('walks all six steps, renders the review, and saves the configuration on finalize', async () => {
    ...
    // The wizard surfaces no printer UI; the prefilled default is passed
    // through so the required `printerConfiguration` wire field is never dropped.
