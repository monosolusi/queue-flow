...
import { CATEGORY_REPOSITORY, QUEUE_REPOSITORY } from '../../domain/queue';
 ...
 * tokens so use-case factories in {@link RestApiModule} can inject them.
 *
...
@Module({
  ...
  exports: [QUEUE_REPOSITORY, COUNTER_ROUTING_RULE_REPOSITORY, CATEGORY_REPOSITORY],
})
